...
$codigoArea			="";	If (isset($_POST["codigoArea"]))		{	$codigoArea 		= $_POST["codigoArea"];			}
	...
	{
		//
		$FUNCOES->cadastro(	array(	"campos" => "codigoProjeto, codigoFrente, nomeFrente, descricaoFrente, codigoTipoProjeto, codigoRecurso, codigoOrigem, codigoFase, dataCadastro, horaCadastro, usuarioCadastro, codigoArea",
									"tabelas" => "dcd_frentes ",
									"values" => " $codigoProjeto, '', '".addslashes($nomeFrente)."', '".addslashes($descricaoFrente)."', '$codigoTipoProjeto', '$codigoRecurso', '$codigoOrigem', '$codigoFase', '".$FUNCOES->DATA."', '".$FUNCOES->HORA."', '".$USUARIO."', '$codigoArea' "
								)
							);
