...
$FUNCOES->consulta(array
			...
			"campos" 	=> " 	usuarioRecurso 'Recurso',
								(select	time_format(sum(m1.horasEsforco), '%H:%i:%s') from dcd_frentes f1, dcd_memoriaprojetos m1 where f1.codigoRecurso = dr.codigoRecurso and f1.codigoFase <> 11 and m1.codigoOrigem = f1.codigoOrigem and m1.codigoTipoProjeto = f1.codigoTipoProjeto and m1.codigoFase = f1.codigoFase) 'Total',
								(select	time_format(sum(m1.horasEsforco), '%H:%i:%s') from dcd_frentes f1, dcd_memoriaprojetos m1 where f1.codigoRecurso = dr.codigoRecurso and f1.codigoStatus = 1 and f1.codigoFase <> 11 and m1.codigoOrigem = f1.codigoOrigem and m1.codigoTipoProjeto = f1.codigoTipoProjeto and m1.codigoFase = f1.codigoFase) 'EmAndamento',
								(select	time_format(sum(m1.horasEsforco), '%H:%i:%s') from dcd_frentes f1, dcd_memoriaprojetos m1 where f1.codigoRecurso = dr.codigoRecurso and f1.codigoStatus = 2 and f1.codigoFase <> 11 and m1.codigoOrigem = f1.codigoOrigem and m1.codigoTipoProjeto = f1.codigoTipoProjeto and m1.codigoFase = f1.codigoFase) 'Parado',
								(select	time_format(sum(m1.horasEsforco), '%H:%i:%s') from dcd_frentes f1, dcd_memoriaprojetos m1 where f1.codigoRecurso = dr.codigoRecurso and f1.codigoStatus = 3 and f1.codigoFase <> 11 and m1.codigoOrigem = f1.codigoOrigem and m1.codigoTipoProjeto = f1.codigoTipoProjeto and m1.codigoFase = f1.codigoFase) 'Cancelado' ",
			"tabelas" 	=> " dcd_recursos dr  ",
			"ordenacao" => " 1 "
			)
		);
...
if ($FUNCOES->GetLinhas()>0)
{
	...
	{
		$linhas=$linhas+1;
		$arrayGrafico[]= array($obj->Recurso, $obj->Total, $obj->EmAndamento, $obj->Parado, $obj->Cancelado);
...
$dataseriesLabels = array(
	new PHPExcel_Chart_DataSeriesValues('String', 'Grafico_Projetos_Por_Recurso!$L$1', NULL, 1),
...
$xAxisTickValues = array(
	new PHPExcel_Chart_DataSeriesValues('String', 'Grafico_Projetos_Por_Recurso!$L$2:$P$'.$linhas.'', NULL, 4),	//	Q1 to Q4
);

$dataSeriesValues = array(
	new PHPExcel_Chart_DataSeriesValues('Number', 'Grafico_Projetos_Por_Recurso!$M$2:$B$'.$linhas.'', NULL, 4),
	new PHPExcel_Chart_DataSeriesValues('Number', 'Grafico_Projetos_Por_Recurso!$N$2:$C$'.$linhas.'', NULL, 4),
	new PHPExcel_Chart_DataSeriesValues('Number', 'Grafico_Projetos_Por_Recurso!$O$2:$D$'.$linhas.'', NULL, 4),
	new PHPExcel_Chart_DataSeriesValues('Number', 'Grafico_Projetos_Por_Recurso!$P$2:$E$'.$linhas.'', NULL, 4),
);
